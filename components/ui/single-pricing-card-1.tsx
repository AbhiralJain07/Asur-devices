...
export function Pricing() {
	return (
		<section className="relative min-h-screen overflow-hidden py-24 sm:py-32 pb-16 sm:pb-20">
			<div id="pricing" className="mx-auto w-full max-w-6xl space-y-5 px-4">
				...
				>
					<h2 className="mt-5 text-center text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tighter">
						Pricing Based on Your Success
					</h2>
					<p className="text-muted-foreground mt-5 text-center text-xs sm:text-sm md:text-base px-4">
				...
				<div className="relative">
					...
					>	
						<div className="grid md:grid-cols-2 bg-background relative border p-4 sm:p-6 gap-6 md:gap-0">
							...
							<div className="w-full px-4 pt-5 pb-4">
								...
								<div className="mt-10 space-y-4">
									...
									<div className="flex justify-center">
										<InteractiveHoverButton text="Start Your Journey" />
									</div>
								</div>
							</div>
							<div className="relative w-full rounded-lg border px-4 pt-5 pb-4">
								...
								<div className="mt-10 space-y-4">
									...
									<div className="flex justify-center">
										<InteractiveHoverButton text="Get Started Now" />
									</div>
								</div>
							</div>
						</div>
