...
export default function Testimonials({ cards }: TestimonialsProps) {
  ...
  const getCardClassName = (index: number, baseClassName: string) => {
    ...
    if (focusedIndex === 0 && index === 1) {
      return baseClassName + " !translate-y-8 sm:!translate-y-12 !translate-x-4 sm:!translate-x-8";
    }
    if (focusedIndex === 0 && index === 2) {
      return baseClassName + " !translate-y-12 sm:!translate-y-20 !translate-x-8 sm:!translate-x-16";
    }
    if (focusedIndex === 1 && index === 2) {
      return baseClassName + " !translate-y-10 sm:!translate-y-16 !translate-x-8 sm:!translate-x-16";
    }
